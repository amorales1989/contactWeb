...
console.log(formattedProducts)
    ...
    const formatProductData = () => {
        ...
        const groupedProducts = productData?.reduce((acc, product) => {
            const { linea, modelo, precio, descripcion, image } = product;
            ...
            if (!acc[linea]) {
                acc[linea] = {
                    ...
                    imageUrl: image || '', // Incluye la URL de la imagen
                    models: []
                };
            } else if (descripcion) {
        ...
        <div className={`contact-page ${darkMode ? 'dark' : ''}`}>
            ...
            <section id="product" className="product-section">
                {formattedProducts.map((product, index) => (
                    ...
                    imageUrl={product.imageUrl} // Pasa la URL de la imagen
                    isDarkMode={darkMode} // Pasa el estado de dark mode
                />
                ))}
            </section>
